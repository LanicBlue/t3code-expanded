...
import Migration0041 from "./Migrations/041_ProjectionThreadsLogicalAgentId.ts";
import Migration0042 from "./Migrations/042_ProjectFlowFinalizations.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionThreadsLogicalAgentId", Migration0041],
  [42, "ProjectFlowFinalizations", Migration0042],
] as const;
